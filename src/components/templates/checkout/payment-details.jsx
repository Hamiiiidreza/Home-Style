        ...
        <div className="flex flex-col items-center py-20 relative">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1fr_413px] gap-8 w-full py-20">
            <div className="flex flex-col gap-6 w-full">
              <div
                className="flex flex-col items-start w-full xl:max-w-[643px] gap-6 px-6 py-10 rounded border border-solid border-neutral-04 transition-all hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]"
              >
                <div
                ...
                <div className="w-full flex justify-between gap-3 items-start">
                  <div className="flex flex-col w-full sm:w-1/2 gap-3">
                    ...
                    >
                      <input
                        className="flex-1 w-full outline-none font-InterRegular text-base text-neutral-04 placeholder:text-neutral-04 tracking-[0] leading-6.5 p-0 transition-all hover:drop-shadow-custom"
              ...
              >
                ...
                <div className="flex flex-col w-full gap-3">
                  ...
                  <div
                    ...
                    <select
                      className="flex-1 w-full grow outline-none font-InterRegular text-base text-neutral-04 tracking-[0] leading-6.5 p-0 appearance-none transition-all hover:drop-shadow-custom"
                    >
              ...
              >
                ...
                <div className="flex flex-col w-full gap-6">
                  <div
                    className="flex flex-col items-start gap-6 pt-0 pb-8 px-0 border-b border-solid border-neutral-04"
                  >
                    <div
                      className="flex items-center justify-between flex-1 bg-neutral-02 border border-solid border-neutral-07 w-full px-4 py-[13px] rounded cursor-pointer transition-all hover:drop-shadow-custom"
                    >
                      <div className="flex items-center w-full gap-3">
                        ...
                        <div
                          className="font-InterRegular flex-1 w-full text-base text-neutral-07 leading-6.5 tracking-[0] whitespace-nowrap transition-all hover:drop-shadow-custom"
                        >
                          Pay by Card Credit
                        </div>
                      </div>
                    ...
                    <div
                      className="flex items-center justify-between flex-1 grow border border-solid border-neutral-07 w-full px-4 py-[13px] rounded cursor-pointer transition-all hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]"
                    >
                  ...
                  <div className="flex flex-col w-full items-start gap-3">
                    ...
                    >
                      <input
                        className="flex-1 w-full grow outline-none font-InterRegular text-base text-neutral-04 placeholder:text-neutral-04 tracking-[0] leading-6.5 p-0 transition-all hover:drop-shadow-custom"
                  ...
                  <div className="w-full flex justify-between items-start gap-3">
                    <div className="flex flex-col w-full sm:w-1/2 gap-3 items-start">
                      <label
                        className="font-InterBold text-neutral-04 text-xs tracking-[0] leading-3 whitespace-nowrap transition-all hover:drop-shadow-custom"
                        for="input-11">
                        Expiration date
            ...
            <div className="w-full xl:w-[413px]">
              <div
                className="flex flex-1 flex-col w-full items-start gap-4 px-6 py-4 bg-white rounded-md border border-solid border-neutral-04 transition-all hover:drop-shadow-custom"
              >
                <div
                ...
                <div className="flex flex-col items-stretch gap-6 self-stretch w-full px-0 py-6">
                  ...
                  <div className="flex items-start gap-3 self-stretch w-full">
                    <div className="flex gap-2 flex-1 w-full grow flex-col items-start transition-all hover:drop-shadow-custom">
                      <div
            ...
            <ButtonCard
                className="all-[unset] box-border flex justify-center items-center gap-2 relative w-full font-InterMedium text-base text-white text-center leading-7 tracking-button-s whitespace-nowrap px-10 py-3 bg-neutral-07 rounded-lg cursor-pointer transition-all hover:drop-shadow-custom xl:col-start-1"
                title="Place Order"
                onClick={handleOrder}
              />
          </div>
