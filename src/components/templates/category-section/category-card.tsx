    ...
    {isTop ? (
      <div>
        <div className="pr-6 pt-5 mb-4">
          <h3 className="font-VazirMedium text-white text-headline-5 mb-3">
            {title}
          </h3>
          <ArrowLink
      ...
      <div className="items-center justify-center sm:justify-evenly flex gap-3 h-full py-5">
        ...
        />
        <div>
          <h3 className="font-VazirMedium text-neutral-07  sm:!text-2xl lg:!text-3xl max-sm:text-xl text-headline-5 mb-3">
            {title}
          </h3>
          <ArrowLink
            title="مشاهده فروشگاه"
