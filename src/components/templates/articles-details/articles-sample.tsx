      ...
      <div className="container w-full overflow-x-hidden">
        <div className="mx-auto flex flex-col gap-14 pt-4 pb-20 bg-white px-4">
          <div className="flex flex-col w-full gap-6 mt-6">
            <span className="font-VazirBold text-xs text-black">
              مقاله
            </span>
            <h1
              className="font-VazirMedium w-full max-w-[834px]
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-3 w-full max-w-[1100px]">
              ...
              <p className="font-VazirRegular text-base leading-7 text-black transition-all hover:drop-shadow-custom">
              ...
              <h2 className="font-VazirMedium text-[24px] md:text-[28px] transition-all hover:drop-shadow-custom">
          ...
          <div className="hidden md:flex flex-col gap-10 w-full">
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <h2 className="font-VazirMedium text-[28px] text-black transition-all hover:drop-shadow-custom">
          ...
          <div className="flex flex-col gap-10 md:hidden w-full">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h2 className="font-VazirMedium text-[24px]">
                فضای ذخیره‌سازی با تأثیر آرام‌بخش
              </h2>
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full">
            ...
            <div className="flex flex-col gap-3 w-full md:w-1/2">
              ...
              <h2 className="font-VazirMedium text-[24px] md:text-[28px]">
