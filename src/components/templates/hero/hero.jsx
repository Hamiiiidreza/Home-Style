...
const Hero = () => (
    <div className="container">
        <section className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-8 w-full py-10 mb-0 md:mb-10 bg-white">
            <h2 className="w-[57.5] text-[40px] md:text-5xl xl:text-7xl font-PoppinsMedium tracking-hero hover:drop-shadow-custom transition-all">
