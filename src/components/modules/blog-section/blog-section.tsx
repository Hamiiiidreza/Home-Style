                ...
                {count === 9 && (
                    <div className="w-full flex justify-center mt-20">
                        <ButtonCard
                            ...
                            className="font-VazirMedium text-neutral-07 text-base text-center leading-7 tracking-button-s whitespace-nowrap box-border inline-flex items-center justify-center gap-2 px-10 py-1.5 rounded-full border border-neutral-07 cursor-pointer transition-all hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]"
                        />
                    </div>
                )}
        </section>
